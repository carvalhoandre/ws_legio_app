...
export default class AtaCreate extends Component {
  ...
  send = async () => {
    ...
    createAtaExtenso(ataExtenso).then(
      () => {
        this.setState({ loading: false });
        this.setState({
          body: `Ata Adicionada com sucesso!`,
          visible: true,
          title: "👏👏👏",
        });
      },
      (error) => {
        this.setState({ loading: false });
        this.setState({
          body: `Erro ao enviar ata por e-mail`,
          visible: true,
          title: "😱😰😰",
        });
      }
      ...
      return (
        <View styles={{ margin: "auto" }}>
          ...
          <TextInput
            ...
            activeUnderlineColor={commonStyles.colors.primaryColor}
            style={styles.input}
            onChangeText={(capituloEspiritual) =>
              this.setState({ capituloEspiritual })
            }
          />
          <TextInput
            type="number"
            ...
            activeUnderlineColor={commonStyles.colors.primaryColor}
            style={styles.input}
            onChangeText={(paginaEspiritual) =>
              this.setState({ paginaEspiritual })
            }
          />
          <TextInput
            label="Título"
            ...
            activeUnderlineColor={commonStyles.colors.primaryColor}
            style={styles.input}
            onChangeText={(titleEspiritual) =>
              this.setState({ titleEspiritual })
            }
          />
      ...
      return (
        <View styles={{ margin: "auto" }}>
          ...
          <TextInput
            ...
            activeUnderlineColor={commonStyles.colors.primaryColor}
            style={styles.input}
            onChangeText={(allocutionAutor) =>
              this.setState({ allocutionAutor })
            }
          />
          ...
          <TextInput
            ...
            activeUnderlineColor={commonStyles.colors.primaryColor}
            style={styles.input}
            onChangeText={(allocutionAssunto) =>
              this.setState({ allocutionAssunto })
            }
          />
      ...
      return (
        <View styles={{ margin: "auto" }}>
          ...
          <TextInput
            ...
            activeUnderlineColor={commonStyles.colors.primaryColor}
            style={styles.input}
            onChangeText={(paragrafoEstudo) =>
              this.setState({ paragrafoEstudo })
            }
          />
        </View>
      );
      ...
      return (
        <View styles={{ margin: "auto" }}>
          ...
          <Text style={styles.obs}>
            Obs: Antes de Salvar verifique os dados
          </Text>
      ...
      >
        <Portal>
          <Dialog visible={this.state.visible} onDismiss={this.hideDialog}>
            <Dialog.Title style={styles.titleOption}>
              {this.state.title}
            </Dialog.Title>
            <Dialog.Content>
        ...
        <ScrollView contentContainerStyle={styles.scrollView}>
          <View style={styles.container}>
            ...
            <View style={styles.containerButton}>{this.returnButtons()}</View>
          </View>
        </ScrollView>
      </SafeAreaView>
    );
