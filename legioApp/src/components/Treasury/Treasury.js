...
export default class Treasury extends Component {
  ...
  send = async () => {
    ...
    let newSA = parseFloat(this.state.saldoAnterior, 10)| 0;
    let newC = parseFloat(this.state.coletaDoDia, 10)| 0;
    let newD = parseFloat(this.state.despesas, 10) | 0;
    let newCDD = parseFloat(this.state.coletaDoDia, 10) | 0;
    let newCTB = parseFloat(this.state.contribuicao, 10) | 0;
    let tot = parseFloat((newSA + newC) - newD - newCTB);
    let sub = newSA + newC;
  ...
  render() {
    ...
    validations.push(validColeta, validSaldo);
    ...
    return this.state.loading ? (
      ...
      <>
        <Portal>
          <Dialog visible={this.state.visible} onDismiss={this.hideDialog}>
            ...
            <Dialog.Content>
              ...
              <Paragraph style={styles.textOption}>
                {this.state.bodySecond}
              </Paragraph>
            </Dialog.Content>
            <Dialog.Actions>
              <Button
        ...
        <Button
          ...
          icon={<Icon name={"send-sharp"} size={20} color={"#FFF"} />}
        />
      </>
    );
  }
