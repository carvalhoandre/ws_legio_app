        ...
        return (
            <ScrollView
                ...
                <View style={styles.container}>
                    ...
                    <Text style={styles.title}>Primeiro Mistério Doloroso: Agonia de Jesus no Horto</Text>
                    ...
                    <Text style={styles.title}>Segundo Mistério Doloroso: Flagelação de Jesus</Text>
                    <Text style={styles.paragraph}>
                        Então lhes soltou Barrabás; mas a Jesus mandou açoitar, e o entregou para ser crucificado (Mt 27,26).
                    </Text>

                    <Text style={styles.title}>Terceiro Mistério Doloroso: Coroação de Espinhos</Text>
                    <Text style={styles.paragraph}>
                    ...
                    <Text style={styles.title}>Quarto Mistério Doloroso: Jesus carregando a cruz no caminho do Calvário</Text>
                    <Text style={styles.paragraph}>
                    ...
                    <Text style={styles.title}>Quinto Mistério Doloroso: Crucifixão e morte de Jesus</Text>
                    <Text style={styles.paragraph}>
