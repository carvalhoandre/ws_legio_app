        ...
        return (
            <ScrollView
                ...
                <View style={styles.container}>
                    ...
                    <Text style={styles.title}>Primeiro Mistério Gozoso: Anunciação a Maria</Text>
                    ...
                    <Text style={styles.title}>Segundo Mistério Gozoso: Visitação de Nossa Senhora a sua prima Isabel</Text>
                    <Text style={styles.paragraph}>
                    ...
                    <Text style={styles.title}>Terceiro Mistério Gozoso: Nascimento de Jesus</Text>
                    <Text style={styles.paragraph}>
                    ...
                    <Text style={styles.title}>Quarto Mistério Gozoso: Apresentação do Menino Jesus no Templo</Text>
                    <Text style={styles.paragraph}>
                    ...
                    <Text style={styles.title}>Quinto Mistério Gozoso: Perda e encontro do Menino Jesus no Templo</Text>
                    <Text style={styles.paragraph}>
