        ...
        return (
            <ScrollView
                ...
                <View style={styles.container}>
                    <Text style={styles.title}>Mistérios Gozosos</Text>
                    
                    <Text style={styles.subtitle}>Primeiro Mistério Gozoso: Anunciação a Maria</Text>
                    ...
                    <Text style={styles.subtitle}>Segundo Mistério Gozoso: Visitação de Nossa Senhora a sua prima Isabel</Text>
                    <Text style={styles.paragraph}>
                    ...
                    <Text style={styles.subtitle}>Terceiro Mistério Gozoso: Nascimento de Jesus</Text>
                    <Text style={styles.paragraph}>
                    ...
                    <Text style={styles.subtitle}>Quarto Mistério Gozoso: Apresentação do Menino Jesus no Templo</Text>
                    <Text style={styles.paragraph}>
                    ...
                    <Text style={styles.subtitle}>Quinto Mistério Gozoso: Perda e encontro do Menino Jesus no Templo</Text>
                    <Text style={styles.paragraph}>
