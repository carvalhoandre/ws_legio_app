        ...
        return (
            <ScrollView
                ...
                <View style={styles.container}>
                    ...
                    <Text style={styles.title}>Primeiro Mistério Glorioso: Ressurreição de Jesus</Text>
                    ...
                    <Text style={styles.title}>Segundo Mistério Glorioso: Ascensão de Jesus ao Céu</Text>
                    <Text style={styles.paragraph}>
                        Depois que o Senhor Jesus lhes falou, foi levado ao céu e está sentado à direita de Deus (Mc 16, 19).
                    </Text>

                    <Text style={styles.title}>Terceiro Mistério Glorioso: Vinda do Espírito Santo sobre os Apóstolos</Text>
                    <Text style={styles.paragraph}>
                    ...
                    <Text style={styles.title}>Quarto Mistério Glorioso: Assunção de Maria</Text>
                    <Text style={styles.paragraph}>
                    ...
                    <Text style={styles.title}>Quinto Mistério Glorioso: Coroação de Maria no Céu</Text>
                    <Text style={styles.paragraph}>
