...
create table tb_ata_extenso (id int4 generated by default as identity, allocution_assunto varchar(255), allocution_autor varchar(255), ata varchar(255), capitulo_espiritual varchar(255), coleta_do_dia varchar(255), data_extenso varchar(255), despesas varchar(255), dia_da_coleta varchar(255), event varchar(255), hora_final varchar(255), minuto_final varchar(255), number varchar(255), numero varchar(255), pagina_espiritual varchar(255), pagina_estudo varchar(255), paragrafo_estudo varchar(255), presentes varchar(255), recrutamento varchar(255), saldo_anterior varchar(255), sub_total varchar(255), title_espiritual varchar(255), total_em_caixa varchar(255), work varchar(255), primary key (id));
